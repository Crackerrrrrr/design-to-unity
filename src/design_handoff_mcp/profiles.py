...
def build_unity_profile(design: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "rules": [
            "Default flow: use Unity Editor API through Unity MCP.",
            "Experimental flow: use lanhu_design_write_unity_prefab_yaml for static UGUI prefab snapshots.",
            ...
            "Direct YAML can add Button for button_candidate and Slider for progress_candidate/slider_candidate.",
